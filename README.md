...
[code-of-conduct]: https://github.com/doinel1a/next-ts-shadcn-hero-ui/blob/main/CODE_OF_CONDUCT.md
...
# Next.js 15 TypeScript, Shadcn/ui & HeroUI — Template
...
This repository is ideal for front-end developers who want to build modern, fast and reliable web applications with the latest cutting edge technologies such as **Next.js 15**, **React.js 19**, **TypeScript**, **Shadcn/ui**, **HeroUI**, **TailwindCSS**, **ESLint**, **Prettier**, **Husky** and much more!
...
[Back to :arrow_up:](#nextjs-15-typescript-shadcnui--heroui--template "Back to 'Table of contents' section")
