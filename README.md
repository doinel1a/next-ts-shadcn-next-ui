...
[license]: https://github.com/doinel1a/next-ts-shadcn-next-ui/blob/main/LICENSE
[code-of-conduct]: https://github.com/doinel1a/next-ts-shadcn-next-ui/blob/main/CODE_OF_CONDUCT.md
[issues]: https://github.com/doinel1a/next-ts-shadcn-next-ui/issues
[pulls]: https://github.com/doinel1a/next-ts-shadcn-next-ui/pulls
...
# Next.js 15 TypeScript, Shadcn/ui & NextUI — Template
...
This repository is ideal for front-end developers who want to build modern, fast and reliable web applications with the latest cutting edge technologies such as **Next.js 15**, **React.js 19**, **TypeScript**, **Shadcn/ui**, **NextUI**, **TailwindCSS**, **ESLint**, **Prettier**, **Husky** and much more!
...
- Get the repository:
  ...
  - **clone** the repository through your terminal: <br />
    ```bash
    git clone https://github.com/doinel1a/next-ts-shadcn-next-ui YOUR-PROJECT-NAME
    ```
...
[Back to :arrow_up:](#nextjs-15-typescript-shadcnui--nextui--template "Back to 'Table of contents' section")
